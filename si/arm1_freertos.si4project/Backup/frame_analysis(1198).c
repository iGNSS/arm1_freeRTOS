...
void navi_test_pack_send(void)
{
    ...
    navi_test_info.accelX |= (imu_info.accelX_h << 8);
    navi_test_info.accelY = imu_info.accelY_l;
    navi_test_info.accelY |= (imu_info.accelY_h << 8);
    navi_test_info.accelZ = imu_info.accelZ_l;
    navi_test_info.accelZ |= (imu_info.accelZ_h << 8);
    navi_test_info.gyroX  = imu_info.gyroX_l;
    navi_test_info.gyroX  |= (imu_info.gyroX_h << 8);
    navi_test_info.gyroY  = imu_info.gyroY_l;
    navi_test_info.gyroY  |= (imu_info.gyroY_h << 8);
    navi_test_info.gyroZ  = imu_info.gyroZ_l;
    navi_test_info.gyroZ  |= (imu_info.gyroZ_h << 8);
    navi_test_info.sensor_temp = imuParseData.sensorTemp;
    sprintf(navi_test_str, "%d,%0.3f,%04x,%04x,%04x,%04x,%04x,%04x,%0.3f,%d,%d,%d,%d,%d,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f", \
    ...
    navi_test_sendBuf[4] = len;
    navi_test_sendBuf[5] = len >> 8;
    memcpy((void*)&navi_test_sendBuf[6], (void*)navi_test_str, len);
    len += 8;
