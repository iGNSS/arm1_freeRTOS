...
#if 1
    sprintf(navi_test_str, "#rawdata,%d,%0.5f,%0.5f,%0.4f,%0.4f,%0.4f,%0.4f,%0.4f,%0.4f,%0.2f,%d,%d,%d,%d,%d,%0.7f,%0.7f,%0.7f,%0.5f,%0.1f,%0.7f,%0.7f,%0.3f,%0.3f,%0.3f,%0.3f,%0.3f,%0.1f\r\n", \
            ...
            navi_test_info.lat,navi_test_info.alt,navi_test_info.vu,navi_test_info.track,navi_test_info.heading,navi_test_info.pitch,navi_test_info.lon_std, \
...
#define EXP_E    		2.718282
    ...
    case 6:
    {
        rs422_frame.data_stream.poll_frame.type = gnss_baseline;
    ...
    pull_couter++;
    if(pull_couter > 6)pull_couter = 0;
